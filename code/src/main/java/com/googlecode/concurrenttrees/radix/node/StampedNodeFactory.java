 ...
 */
public interface StampedNodeFactory {
     ...
     */
    AtomicStampedReference<Node> createStampedNode(CharSequence edgeCharacters, Object value, List<Node> childNodes, boolean isRoot);
    Node createNode(CharSequence edgeCharacters, Object value, List<Node> childNodes, boolean isRoot);
	Node createNode(CharSequence incomingEdge, Object value,
