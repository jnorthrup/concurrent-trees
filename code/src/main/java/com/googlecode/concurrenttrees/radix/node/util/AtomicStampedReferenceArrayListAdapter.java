 ...
 */
public class AtomicStampedReferenceArrayListAdapter<T> extends AbstractList<T> {

    private final AtomicStampedReference<T> [] atomicReferenceArray;

    public AtomicStampedReferenceArrayListAdapter(AtomicStampedReference<T> []atomicReferenceArray) {
        this.atomicReferenceArray = atomicReferenceArray;
    }

    @Override
    public T get(int index) {
        return  atomicReferenceArray[index].getReference();
    }
